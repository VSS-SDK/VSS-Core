...
State FieldTransformation::spinField180Degrees(State state){
...
Robot FieldTransformation::spin180Degrees(Robot robot){
...
Ball FieldTransformation::spin180Degrees(Ball ball){
    // 170 is the size in x of the field
    ball.x = 170 - ball.x;
    // 130 is the size in y of the field    
    ball.y = 130 - ball.y;
